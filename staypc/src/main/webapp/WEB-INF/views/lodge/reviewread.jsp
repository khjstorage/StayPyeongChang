...
<body>
	...
	<table style="border:0px; width:600px;">
	 	<tr>
	 		<th rowspan="2" align="center" width="auto">${vo.review_num }</th>
	 		<th align="center" width="auto">${vo.id }</th><th colspan="7"></th>
	 		</tr>
	 		<tr>
	 		<th align="center" width="auto"><fmt:formatDate value="${vo.reg_date }" pattern="yyyy년MM월dd일"/> </th>
	 		<th colspan="8"></th>
	 		</tr>
	 	<tr>
	 		<td colspan="9">${vo.content}</td>
	 	</tr>
	 	<tr>
	 		<td colspan="9" align="right">
	 			<input type="button" value="리스트" onclick="location.href='boardList.do'">
	 			<input type="button" value="삭 제" onclick="board_delete()">
	 			<input type="button" value="수정 하기" onclick="location.href='update.do?review_num=${vo.review_num}'">
	 			<!--  
