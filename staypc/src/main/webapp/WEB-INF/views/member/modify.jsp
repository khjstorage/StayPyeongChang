                    ...
                    <div class="user_profile">
                            ...
                            <div class="radio_email">
                                <c:choose>
                                    <c:when test="${member.email_yn eq 'Y'}">
                                        <input type="radio" id="email_unlock" value="Y" name="email_yn"
                                               checked="checked" style="margin-left:30px;"> 공개
                                        <input type="radio" id="email_lock" value="N" name="email_yn"
                                               style="margin-left:10px;"> 비공개
                                    </c:when>
                                    <c:when test="${member.email_yn eq 'N'}">
                                        <input type="radio" id="email_unlock" value="Y" name="email_yn"
                                               style="margin-left:30px;"> 공개
                                        <input type="radio" id="email_lock" value="N" name="email_yn" checked="checked"
                                               style="margin-left:10px;"> 비공개
                                    </c:when>
                                    <c:otherwise>
                                        <input type="radio" id="email_unlock" value="Y" name="email_yn"
                            ...
                            <div class="radio_phone">
                                <c:choose>
                                    <c:when test="${member.phone_yn eq 'Y'}">
                                        <input type="radio" id="phone_unlock" value="Y" name="phone_yn"
                                               checked="checked" style="margin-left:80px;"> 공개
                                        <input type="radio" id="phone_lock" value="N" name="phone_yn"
                                               style="margin-left:10px;"> 비공개
                                    </c:when>
                                    <c:when test="${member.phone_yn eq 'N'}">
                                        <input type="radio" id="phone_unlock" value="Y" name="phone_yn"
                                               style="margin-left:80px;"> 공개
                                        <input type="radio" id="phone_lock" value="N" name="phone_yn" checked="checked"
                                               style="margin-left:10px;"> 비공개
                                    </c:when>
                                    <c:otherwise>
                                        <input type="radio" id="phone_unlock" value="Y" name="phone_yn"
                            ...
                            <div class="radio_city">
                                <c:choose>
                                    <c:when test="${member.city_yn eq 'Y'}">
                                        <input type="radio" id="city_unlock" value="Y" name="city_yn" checked="checked"
                                               style="margin-left:80px;"> 공개
                                        <input type="radio" id="city_lock" value="N" name="city_yn"
                                               style="margin-left:10px;"> 비공개
                                    </c:when>
                                    <c:when test="${member.city_yn eq 'N'}">
                                        <input type="radio" id="city_unlock" value="Y" name="city_yn"
                                               style="margin-left:80px;"> 공개
                                        <input type="radio" id="city_lock" value="N" name="city_yn" checked="checked"
                                               style="margin-left:10px;"> 비공개
                                    </c:when>
                                    <c:otherwise>
                                        <input type="radio" id="city_unlock" value="Y" name="city_yn"
                        ...
                        <div class="introduction">
                            ...
                            <div class="user_introduction">
                                <textarea cols="80" rows="10" name="introduction"
